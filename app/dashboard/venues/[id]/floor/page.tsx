...
export default async function VenueFloorPage({
  params,
}: {
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {venue.floors.map((floor) => (
          <Card key={floor.id} className="hover:shadow-md transition-shadow">
            <CardHeader className="pb-3">
              ...
              <CardDescription>Floor plan and navigation graph</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card className="border-dashed border-2 hover:border-primary/50 transition-colors">
          <CardContent className="flex flex-col items-center justify-center h-full min-h-[200px] text-center">
            ...
            <h3 className="font-medium text-muted-foreground">Add New Floor</h3>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Start by adding your first floor plan to begin mapping your venue.
            </p>
